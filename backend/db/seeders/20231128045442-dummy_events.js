   ...
   await Event.bulkCreate([
    {
      ...
      groupId: 1,
      name: 'Festival',
      description: 'Fun in the sun for the mun. We just wanna have a good night and a good day. Come on down to join us.',
      type: 'In person',
      capacity: 50,
      price: 0.00,
    ...
    },
    {
      ...
      groupId: 2,
      name: 'Convention',
      description: 'Science show, we are highlighting all of the most recent and the most exciting discoveries and experiments our group has done and what is yet to come.',
      type: 'In person',
      capacity: 100,
      price: 10.00,
    ...
    },
    {
      ...
      groupId: 3,
      name: 'Meet and greet',
      description: 'Show and tell for everyone to be able to share what they are interested as well as a piece of their life/culture.',
      type: 'Online',
      capacity: 20,
      price: 0.00,
      startDate: '2023-10-22',
